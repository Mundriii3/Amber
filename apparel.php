...
<head>
  <meta charset="utf-8">
  <title><?php echo e(SITE_NAME); ?> — Apparel</title>
...
<main class="wrap">
  <section class="card">
    <h2>Apparel</h2>
    <p class="small">Aesthetically A merch — secure checkout via PayPal.</p>

    <?php if (!$apparel): ?>
      <p>No apparel items yet. Check back soon.</p>
    <?php else: ?>
      <div class="product-grid">
        <?php foreach ($apparel as $index => $item): ?>
          <div class="product-card">
            ...
            <div id="paypal-apparel-<?php echo $index; ?>"></div>
              ...
              paypal.Buttons({
                ...
                onApprove: function(data, actions) {
                  return actions.order.capture().then(function(details) {
                    alert("Thank you for your purchase of " + name + "! You’ll receive an email from PayPal with your receipt.");
                  });
                }
              }).render('#paypal-apparel-<?php echo $index; ?>');
            })();
            </script>
          </div>
        <?php endforeach; ?>
